...
private:
  ...
  bool notchinese;
  bool algorithmUnsafe; // True after reset until safely re-initialized
...
public:
  ...
  bool isAlgorithmUnsafe() const { return algorithmUnsafe; }
  void markAlgorithmSafe() { algorithmUnsafe = false; }
};
#endif
